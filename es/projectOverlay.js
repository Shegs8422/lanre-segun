      ...
      <div style="display:flex;gap:2.2rem;align-items:flex-start;flex-wrap:wrap;padding:0 2.2rem;">
        ...
        <div style="flex:0 0 260px;display:flex;flex-direction:column;align-items:center;min-width:220px;">
          ...
          <div style="width:100%;margin-top:1.2rem;">
            <div style="font-size:1.05rem;font-weight:700;margin-bottom:0.5rem;">Herramientas</div>
        ...
        <div style="flex:1;min-width:220px;display:flex;flex-direction:column;align-items:flex-start;gap:1.1rem;">
          ...
          <div style="width:100%;">
            ...
            <button class="desc-more-btn" style="display:none;font-size:0.98rem;color:#1a73e8;background:none;border:none;cursor:pointer;padding:0;margin:0;">Más</button>
          </div>
          <div class="overlay-features-box" style="background:#f7f8fa;border-radius:14px;padding:1.1rem 1.2rem;width:100%;box-shadow:0 1px 6px #0001;">
            <div style="color:#222;font-weight:700;margin-bottom:0.3rem;">Características y Alcance del Proyecto</div>
            <ul class="feature-list" style="margin:0 0 0 1.2rem;padding:0;color:#444;font-size:1rem;line-height:1.7;"></ul>
          </div>
          <a class="overlay-link" href="#" target="_blank" style="align-self:flex-end;margin-top:0.7rem;padding:0.7rem 1.5rem;background:#222;color:#fff;font-weight:700;border-radius:8px;text-decoration:none;box-shadow:0 2px 8px #0001;transition:background 0.2s;">Ver Proyecto</a>
        </div>
      </div>
    </div>
    <style>
